...
const screenshots: Screenshot[] = [
 {
  ...
  description:
   "Organize and manage all your workspaces from a clean, intuitive interface",
 ...
 },
 {
  ...
  description:
   "Easily configure actions, tools, and variables for each workspace",
 ...
 },
 {
  ...
  description:
   "Switch between light and dark modes, or create your own custom theme with the built-in theme creator",
...
const Screenshots = () => {
 ...
 const [sliderPositions, setSliderPositions] = createSignal<
     ...
     {screenshots.map((screenshot, index) => (
      <div class="group flex flex-col">
       <div class="relative bg-gray-900/60 backdrop-blur-sm rounded-2xl overflow-hidden border-2 border-gray-700 hover:border-primary-500/70 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/20 hover:-translate-y-2 flex-grow flex flex-col">
        {screenshot.isComparison &&
        screenshot.compareImageUrl &&
        screenshot.imageUrl ? (
         <div
         ...
         <button
          ...
          onClick={() =>
           screenshot.imageUrl &&
           openLightbox(screenshot.imageUrl, screenshot.alt, screenshot.title)
          }
          aria-label={
           screenshot.imageUrl
            ? `View full size ${screenshot.title}`
            : undefined
          }
         >
          {screenshot.imageUrl ? (
    ...
    <Show when={selectedImage()}>
     <Portal>
      ...
      >
       ...
       >
        <div
         class="relative w-full max-w-[95vw] max-h-[95vh] flex flex-col"
         role="none"
        >
