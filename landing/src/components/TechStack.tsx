		...
		<section class="py-32 bg-gradient-to-b from-gray-900 to-gray-800">
			<div class="section-container">
				<div class="text-center mb-20">
					<h2 class="text-4xl md:text-5xl font-bold text-white mb-4">Built with Modern Tech</h2>
				...
				<div class="flex flex-wrap justify-center gap-4">
					{technologies.map((tech) => (
						<div class={`${tech.color} px-6 py-3 rounded-lg text-white font-semibold shadow-lg`}>{tech.name}</div>
					))}
				</div>
			</div>
		</section>
