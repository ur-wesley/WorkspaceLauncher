...
const Hero = (props: Props) => {
 ...
 onMount(async () => {
  try {
   const response = await fetch(
    "https://api.github.com/repos/ur-wesley/WorkspaceLauncher/releases/latest"
   );
   if (response.ok) {
 ...
 const releasePageUrl = () =>
  `https://github.com/ur-wesley/WorkspaceLauncher/releases/tag/v${version()}`;
 const formattedDate = () => {
     ...
     <div class="max-w-4xl mx-auto text-center lg:text-left">
      <div class="flex flex-col justify-center space-y-6">
       <h1 class="font-bold text-white mb-6 drop-shadow-[0_0_30px_rgba(0,0,0,0.8)] overflow-visible">
        ...
        <div class="text-3xl md:text-4xl lg:text-5xl font-extrabold mt-6">
         With One Click
        </div>
       </h1>
       ...
       <div class="flex flex-col items-center lg:items-start gap-4">
        ...
        <div class="flex flex-col items-center lg:items-start gap-1 backdrop-blur-sm bg-gray-900/20 rounded-lg px-3 py-2 lg:bg-transparent lg:p-0">
         ...
         {releaseDate() && (
          <p class="text-xs text-gray-400 drop-shadow-md">
