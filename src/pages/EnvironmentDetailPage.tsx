		...
		<div class="p-6 space-y-6">
			...
			<div class="flex items-center justify-between">
				<div>
					...
					<p class="text-muted-foreground">Configure actions, variables, and run this environment</p>
				</div>
			...
			<Tabs defaultValue="actions" class="space-y-6">
					...
					<div class="space-y-4">
						...
						<Card class="border-dashed border-2 hover:(border-primary) transition-colors cursor-pointer">
							<CardContent class="flex flex-col items-center justify-center py-12">
								...
								<p class="text-sm text-muted-foreground text-center">Add your first action to get started</p>
							</CardContent>
						</Card>
					</div>
				</TabsContent>
				...
				<TabsContent value="variables" class="space-y-6">
					...
					<div class="text-center py-12">
						...
						<p class="text-muted-foreground mb-4">Create variables to use in your actions and commands</p>
						<Button>
							<div class="i-mdi-plus w-4 h-4 mr-2" />
							Add Variable
						</Button>
				...
				<TabsContent value="runs" class="space-y-6">
					...
					<div class="text-center py-12">
						...
						<p class="text-muted-foreground mb-4">Run this environment to see execution history</p>
						<Button>
							<div class="i-mdi-play w-4 h-4 mr-2" />
							Run Environment
						</Button>
					...
					<Card>
						<CardContent class="p-0">
							<div class="bg-slate-950 text-green-400 font-mono text-sm p-4 min-h-96 overflow-auto">
								<div class="text-muted-foreground">Waiting for environment execution...</div>
							</div>
						</CardContent>
					</Card>
				</TabsContent>
