     ...
     <form onSubmit={handleSubmit} class="space-y-6">
       ...
       <div class="space-y-2">
        ...
        >
         <ToggleGroupItem value="cli">
          <span class="iconify w-4 h-4 mr-2" data-icon="mdi:console" /> CLI
          Command
         </ToggleGroupItem>
         <ToggleGroupItem value="binary">
          <span class="iconify w-4 h-4 mr-2" data-icon="mdi:application" />{" "}
          Binary Executable
         </ToggleGroupItem>
        </ToggleGroup>
        <p class="text-xs text-muted-foreground">
         CLI: Command-line tools (npm, bun, code). Binary: Direct executable
         files (.exe, .app)
        </p>
       </div>
      ...
      <div class="space-y-4">
       ...
       <TextFieldRoot>
        ...
        />
        <div class="text-xs text-muted-foreground mt-1">
         Define placeholders used in the template. Each placeholder should have:
         name, description, required, type (text/path/url/number), and optional
         default value.
        </div>
       </TextFieldRoot>
      </div>
