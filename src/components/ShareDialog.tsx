  ...
  <Dialog open={open()} onOpenChange={setOpen}>
   ...
   <DialogContent class="max-w-3xl max-h-[80vh] flex flex-col">
    <DialogHeader>
     ...
     <DialogDescription>
      Select workspaces and tools to export. You can save to a file or copy to
      clipboard.
     </DialogDescription>
    </DialogHeader>
    ...
    <div class="flex justify-between pt-4 border-t">
     ...
     <div class="flex gap-2">
      <Button variant="outline" onClick={() => handleExport(true)}>
       <span class="iconify w-4 h-4 mr-2" data-icon="mdi:content-copy" /> Copy
       to Clipboard
      </Button>
      <Button onClick={() => handleExport(false)}>
       <span class="iconify w-4 h-4 mr-2" data-icon="mdi:download" /> Export to
       File
      </Button>
     </div>
    </div>
