			...
			<Dialog open={isOpen()} onOpenChange={handleOpenChange}>
				<DialogContent class="max-w-2xl max-h-[90vh] overflow-y-auto">
					<DialogHeader>
						...
						<DialogDescription>
							{props.action ? "Modify the action configuration." : "Create a new action for this workspace."}
						</DialogDescription>
					</DialogHeader>
							...
							<div class="space-y-4">
								<div>
									...
									>
										...
										<For each={allowedTools()}>{(tool) => <option value={tool.id.toString()}>{tool.name}</option>}</For>
									</select>
									<Show when={selectedTool()}>
										{(tool) => <p class="text-xs text-muted-foreground mt-1">{tool().description}</p>}
									</Show>
								</div>
							...
							<div class="space-y-4">
									...
									<div class="space-y-2">
										<TextFieldRoot>
											...
											<TextField
												...
												required
											/>
											<p class="text-xs text-muted-foreground mt-1">Use ${"{VAR}"} to reference workspace variables.</p>
										</TextFieldRoot>
								...
								<Show when={customToolType() === "binary"}>
									<TextFieldRoot>
										...
										<p class="text-xs text-muted-foreground mt-1">Provide the full path or rely on PATH resolution.</p>
									</TextFieldRoot>
								</Show>
								...
								<TextFieldRoot>
									...
									/>
									<p class="text-xs text-muted-foreground mt-1">Each line becomes a separate argument when executed.</p>
								</TextFieldRoot>
								...
								<TextFieldRoot>
									...
									<p class="text-xs text-muted-foreground mt-1">Leave blank to use the default working directory.</p>
								</TextFieldRoot>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div class="flex items-center justify-between space-x-2">
								<div class="space-y-0.5">
									...
									<p class="text-xs text-muted-foreground">
										Launch without waiting for completion (recommended for GUI apps like Eclipse)
									</p>
								</div>
							...
							<div class="flex items-center justify-between space-x-2">
								<div class="space-y-0.5">
									...
									<p class="text-xs text-muted-foreground">
										Monitor process lifecycle (uncheck for fire-and-forget actions like opening URLs or new browser
										tabs)
									</p>
								</div>
