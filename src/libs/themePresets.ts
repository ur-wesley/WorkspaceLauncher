...
export const defaultTheme: ThemePreset = {
	name: "Default",
	description: "Classic light and dark theme",
	light: {
		background: "0 0% 100%",
...
export const catppuccinLatteFrappe: ThemePreset = {
	name: "Catppuccin Latte/Frappé",
	description: "Warm pastel theme with soothing colors",
	light: {
		...
		muted: "220 17% 88%",
		mutedForeground: "233 13% 54%",
		accent: "218 54% 71%",
		accentForeground: "234 16% 35%",
		destructive: "347 87% 44%",
		destructiveForeground: "220 23% 97%",
		border: "220 16% 82%",
		input: "220 16% 82%",
		ring: "217 92% 59%",
	},
	dark: {
		...
		muted: "233 12% 27%",
		mutedForeground: "228 39% 66%",
		accent: "220 57% 77%",
		accentForeground: "240 21% 15%",
		destructive: "347 87% 63%",
...
export const catppuccinMacchiatoMocha: ThemePreset = {
	name: "Catppuccin Macchiato/Mocha",
	description: "Deep and rich dark color palette",
	light: {
		background: "233 25% 18%",
		...
		primary: "220 91% 71%",
		primaryForeground: "233 25% 18%",
		secondary: "233 12% 29%",
		secondaryForeground: "227 70% 87%",
		muted: "233 12% 29%",
		mutedForeground: "229 40% 65%",
		accent: "189 71% 72%",
		accentForeground: "233 25% 18%",
		destructive: "355 76% 66%",
